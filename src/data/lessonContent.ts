...
export const lessonContent: Record<string, TopicLesson> = {
  ...
  shapes: {
    ...
    slides: [
      ...
      { id: 's-oval',      image: '2ov.png', labelEn: 'Oval',      labelFil: 'Ovalado',   audioEn: aud('2o.mp3'),  audioFil: aud('2hab.MP3')  },
      { id: 's-diamond',   image: '2d.png',  labelEn: 'Diamond',   labelFil: 'Diyamante', audioEn: aud('2d.mp3'),  audioFil: aud('2dia.MP3')  },
      { id: 's-heart',     image: '2h.png',  labelEn: 'Heart',     labelFil: 'Puso',      audioEn: aud('2h.mp3'),  audioFil: aud('2pu.MP3')   },
      { id: 's-star',      image: '2s.png',  labelEn: 'Star',      labelFil: 'Bituin',    audioEn: aud('2s.mp3'),  audioFil: aud('2tala.MP3') },
    ],
  },
  ...
  subtraction: {
    ...
    slides: [
      ...
      { id: 'sub-v1',      video: '5subv.mp4', labelEn: 'Video Activity 1',              labelFil: 'Bidyo Gawain 1' },
      { id: 'sub-v2',      video: '5v1.mp4',   labelEn: 'Video Activity 2',              labelFil: 'Bidyo Gawain 2' },
      ...
      { id: 'sub-e',       image: '5pd.png',   labelEn: 'Subtracting more',              labelFil: 'Pagsasanay sa pagbabawas' },
      { id: 'sub-f',       image: '5pe.jpg',   labelEn: 'Subtracting objects',           labelFil: 'Magbawas pa!' },
      { id: 'sub-g',       image: '5f.jpg',    labelEn: 'Subtraction practice 1',        labelFil: 'Pagsasanay 1' },
      { id: 'sub-h',       image: '5g.jpg',    labelEn: 'Subtraction practice 2',        labelFil: 'Pagsasanay 2' },
      { id: 'sub-i',       image: '5h.jpg',    labelEn: 'Subtraction practice 3',        labelFil: 'Pagsasanay 3' },
      { id: 'sub-j',       image: '5i.jpg',    labelEn: 'Subtraction practice 4',        labelFil: 'Pagsasanay 4' },
      { id: 'sub-k',       image: '5j.jpg',    labelEn: 'Subtraction practice 5',        labelFil: 'Pagsasanay 5' },
      { id: 'sub-l',       image: '5k.jpg',    labelEn: 'Subtraction practice 6',        labelFil: 'Pagsasanay 6' },
      { id: 'sub-m',       image: '5l.jpg',    labelEn: 'Subtraction practice 7',        labelFil: 'Pagsasanay 7' },
      { id: 'sub-n',       image: '5m.jpg',    labelEn: 'Subtraction practice 8',        labelFil: 'Pagsasanay 8' },
      { id: 'sub-o',       image: '5n.jpg',    labelEn: 'Subtraction practice 9',        labelFil: 'Pagsasanay 9' },
    ],
  },
