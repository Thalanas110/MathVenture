...
export const lessonContent: Record<string, TopicLesson> = {
  ...
  addition: {
    ...
    slides: [
      ...
      { id: 'add-b', image: '4b.png', labelEn: 'Count them together' },
      { id: 'add-c', image: '4c.png', labelEn: 'Sum of objects' },
      { id: 'add-d', image: '4d.png', labelEn: 'Number sentence' },
      { id: 'add-e', image: '4e.png', labelEn: 'Practice problems' },
      { id: 'add-f', image: '4f.png', labelEn: 'More practice' },
      { id: 'add-g', image: '4g.png', labelEn: 'Keep counting' },
      { id: 'add-411', image: '411.png', labelEn: 'Addition example 1' },
      { id: 'add-412', image: '412.png', labelEn: 'Addition example 2' },
      { id: 'add-413', image: '413.png', labelEn: 'Addition example 3' },
      { id: 'add-414', image: '414.png', labelEn: 'Addition example 4' },
      { id: 'add-415', image: '415.png', labelEn: 'Addition example 5' },
      { id: 'add-416', image: '416.png', labelEn: 'Addition example 6' },
      { id: 'add-417', image: '417.png', labelEn: 'Addition example 7' },
      { id: 'add-418', image: '418.png', labelEn: 'Addition example 8' },
      { id: 'add-419', image: '419.png', labelEn: 'Addition example 9' },
      { id: 'add-420', image: '420.png', labelEn: 'Addition example 10' },
  ...
  subtraction: {
    ...
    slides: [
      ...
      { id: 'sub-b', image: '5pa.png', labelEn: 'How many are left?' },
      { id: 'sub-c', image: '5pb.jpg', labelEn: 'Subtraction sentence' },
      { id: 'sub-d', image: '5pc.jpg', labelEn: 'Finding the difference' },
      { id: 'sub-e', image: '5pd.png', labelEn: 'Subtracting more' },
      { id: 'sub-f', image: '5pe.jpg', labelEn: 'Subtracting objects' },
      { id: 'sub-g', image: '5f.jpg', labelEn: 'Subtraction practice 1' },
      { id: 'sub-h', image: '5g.jpg', labelEn: 'Subtraction practice 2' },
      { id: 'sub-i', image: '5h.jpg', labelEn: 'Subtraction practice 3' },
      { id: 'sub-j', image: '5i.jpg', labelEn: 'Subtraction practice 4' },
      { id: 'sub-k', image: '5j.jpg', labelEn: 'Subtraction practice 5' },
      { id: 'sub-l', image: '5k.jpg', labelEn: 'Subtraction practice 6' },
      { id: 'sub-m', image: '5l.jpg', labelEn: 'Subtraction practice 7' },
      { id: 'sub-n', image: '5m.jpg', labelEn: 'Subtraction practice 8' },
      { id: 'sub-o', image: '5n.jpg', labelEn: 'Subtraction practice 9' },
    ],
  },
  ...
  measurement: {
    ...
    slides: [
      ...
      { id: 'm-v1', video: 'mvlength.mp4', labelEn: 'Video Activity 1', labelFil: 'Bidyo Gawain 1' },
      { id: 'm-v2', video: 'mv2.mp4', labelEn: 'Video Activity 2', labelFil: 'Bidyo Gawain 2' },
      { id: 'm-v3', video: 'mv3.mp4', labelEn: 'Video Activity 3', labelFil: 'Bidyo Gawain 3' },
      { id: 'm-v4', video: 'mvb.mp4', labelEn: 'Video Activity 4', labelFil: 'Bidyo Gawain 4' },
      { id: 'm-6', image: 'mt.png', labelEn: 'Measurement practice 1', labelFil: 'Pagsasanay 1' },
      ...
      { id: 'm-7', image: 'mt6.png', labelEn: 'Measurement practice 2', labelFil: 'Pagsasanay 2' },
      ...
      { id: 'm-8', image: 'mt9.png', labelEn: 'Measurement practice 3', labelFil: 'Pagsasanay 3' },
      { id: 'm-9', image: 'mt12.png', labelEn: 'Measurement practice 4', labelFil: 'Pagsasanay 4' },
      { id: 'm-10', image: 'mt8.png', labelEn: 'Measurement practice 5', labelFil: 'Pagsasanay 5' },
      { id: 'm-11', image: 'mt11.png', labelEn: 'Measurement practice 6', labelFil: 'Pagsasanay 6' },
      { id: 'm-12', image: 'mt10.png', labelEn: 'Measurement practice 7', labelFil: 'Pagsasanay 7' },
      { id: 'm-13', image: 'mt13.png', labelEn: 'Measurement practice 8', labelFil: 'Pagsasanay 8' },
    ],
  },
  ...
  comparison: {
    ...
    slides: [
      ...
      { id: 'cmp-v1', video: 'comv.mp4', labelEn: 'Video Activity 1', labelFil: 'Bidyo Gawain 1' },
      { id: 'cmp-v2', video: 'cvlength.mp4', labelEn: 'Video Activity 2', labelFil: 'Bidyo Gawain 2' },
      { id: 'cmp-v3', video: 'cv2.mp4', labelEn: 'Video Activity 3', labelFil: 'Bidyo Gawain 3' },
      { id: 'cmp-v4', video: 'cvb.mp4', labelEn: 'Video Activity 4', labelFil: 'Bidyo Gawain 4' },
      { id: 'cmp-v5', video: 'cv5.mp4', labelEn: 'Video Activity 5', labelFil: 'Bidyo Gawain 5' },
      ...
      { id: 'cmp-6', image: 'cp6.png', labelEn: 'Comparison practice 1', labelFil: 'Pagsasanay 1' },
      { id: 'cmp-7', image: 'cp7.png', labelEn: 'Comparison practice 2', labelFil: 'Pagsasanay 2' },
      { id: 'cmp-8', image: 'cp8.jpg', labelEn: 'Comparison practice 3', labelFil: 'Pagsasanay 3' },
    ],
  },
