...
export const lessonContent: Record<string, TopicLesson> = {
  ...
  addition: {
    ...
    slides: [
      ...
      { id: 'add-e', image: '4e.png', labelEn: 'Example 4' },
      { id: 'add-f', image: '4f.png', labelEn: 'Example 5' },
      { id: 'add-g', image: '4g.png', labelEn: 'Example 6' },
  ...
  subtraction: {
    ...
    slides: [
      ...
      { id: 'sub-f', image: '5pe.jpg', labelEn: 'Example 5' },
      { id: 'sub-g', image: '5f.jpg', labelEn: 'Example 6' },
      { id: 'sub-h', image: '5g.jpg', labelEn: 'Example 7' },
      { id: 'sub-i', image: '5h.jpg', labelEn: 'Example 8' },
      { id: 'sub-j', image: '5i.jpg', labelEn: 'Example 9' },
      { id: 'sub-k', image: '5j.jpg', labelEn: 'Example 10' },
